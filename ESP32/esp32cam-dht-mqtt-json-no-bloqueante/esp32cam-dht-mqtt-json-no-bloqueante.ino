...
Enviar Temperatyra y humedad del DHT11 en JSON 
por MQTT con el ESP32CAM - No bloqueante

por: Hugo Escalpelo
Fecha: 6 de julio de 2023

Este programa realiza la lectura del DHT11 para obtener temperatura y
humedad, envía un mensaje JSON vía MQTT con el ESP32CAM. En las 
variables se indica el tema MQTT en el que se envìa y recibe información. 
Para ello es necesario configurar el nombre de red e IP del broker MQTT. 

Para este ejercicio se requiere el sensor DHT11
